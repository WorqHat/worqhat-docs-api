...
```json
{
  "output": {
    ...
    "message": "Successfully fetched 13 documents",
    "status": "success"
  }
}
```
...
```json
{
  "output": {
    ...
    "data": [
      { "id": "10", "name": "Amanda Taylor", "created_at": "2023-10-01T12:00:00.000Z", "active": "yes" },
      { "id": "5", "name": "David Wilson", "created_at": "2023-05-12T11:00:00.000Z", "active": "yes" }
    ],
