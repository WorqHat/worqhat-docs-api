...
Here’s your **Input Parameters** section rewritten in clear bullet-point format for the **Image Analysis** node — keeping it consistent, beginner-friendly, and ready for your docs:
...
Access variable references dynamically using:
...
```json
{
  ...
  "question": "What type of building is in this image?"
}
```
...
Here’s your **Common Errors** section rewritten in bullet-point format for the **Image Analysis** node — clear, concise, and beginner-friendly:
