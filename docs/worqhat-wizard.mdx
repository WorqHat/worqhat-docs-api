...
WorqHat Wizard is open source and welcomes contributions. If you find an issue or have a feature request, please open an issue on our GitHub repository. Pull requests are also welcome.


For general questions or feedback, you can reach out to us at [sagnik@worqhat.com](mailto:sagnik@worqhat.com).
